...
export const COUNTRY_POLICY_SEEDS: Record<
  string,
  {
  ...
  Austria: {
    receiptStandards: [
      {
        ...
        expense_type:
          'Hotel, Flight, Restaurant, Office supplies, Software, Equipment, Training, Mileage, Entertainment, Utilities, Professional services, Medical',
    ...
    compliancePoliciesGrossUpRelated: [
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'All expenses that has been approved by the client as a business expense will be NET to the employee (grossed up if not tax free)',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        gross_up: true,
        gross_up_rule:
          'Maximum €0.42 per betrieblich gefahrenen kilometer, maximum €12,600 per year steuerfrei. Parking tickets taxed if paid outside of Mileage payment',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel',
        ...
        gross_up: true,
        gross_up_rule:
          'Lodging should be paid separately upon receiving the proper invoice/receipt or €15 without a receipt. With proper receipt can be reimbursed in full tax-free',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'Domestic: maximum €26.40 per day tax-free (12 hours maximum). If meals provided by employer/host, per diem reduced by 50%. International: government per diem rates apply, daily rate may be increased but receipt required for amount above set rate to be tax-exempt',
      },
      {
        travel_non_travel_both: 'Both',
    ...
    compliancePoliciesAdditionalInfoRelated: [
      ...
      },
      {
        ...
        additional_info_rule:
          'Travel reporting template must be submitted. Map with the relevant route (google maps is sufficient) required. Voraussetzung für die steuerfreie Behandlung der Kilometergelder ist die genaue fortlaufende Führung eines Fahrtenbuches oder eines anderen gleichwertigen Nachweises',
      },
      {
        travel_non_travel_both: 'Travel',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Domestic business trips: per diem entitlement for workers who travel more than 25 kilometres from their place of business. Per diem method cannot be mixed with actual expenses - need to agree with worker on one method per business trip',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
        ...
        additional_info_required: true,
        additional_info_rule:
          'International business trips: per diem method cannot be mixed with actual expenses - need to agree with worker on one method per business trip. If lunch and dinner are provided on trip, per diem allowance reduced by two thirds',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: false,
        gross_up_rule:
          'Business expenses related to workers completing their job will usually be tax exempt. Home office equipment, tools and supplies are considered tax exempt',
      },
      {
        travel_non_travel_both: 'Non-Travel',
      ...
      },
      {
        ...
        gross_up: false,
        gross_up_rule:
          'Business-related travel expenses including transportation costs, meals, hotels, exceptional and justified business costs are tax exempt',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Mileage compensation for professional travel €0.428 per km as of 01.07.2023 until 30.06.2024, not taxable if does not exceed allowance State grants to its staff, valid only if number of kilometres driven annually is not abnormally high (maximum 24,000 km/year)',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        gross_up: true,
        gross_up_rule:
          'Travel from work to home: amount of reimbursement may not exceed sum of EUR 0.15 per kilometer of distance, calculated on basis of outward and return distances',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'Entertainment expenses are considered non-tax exempt including nightclubs, cocktail lounges, theaters, country clubs, golf and athletic clubs, sporting events, hunting and fishing',
      },
    ],
    compliancePoliciesAdditionalInfoRelated: [
      {
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'For foreign currency expenses, convert amount to local currency and include currency and exchange rate used (e.g., https://www.xe.com)',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'For mileage reimbursements, use GoGlobal mileage log report, include To and From locations, distance travelled and applicable mileage rates as per the log',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'For business related travel, employee must be able to prove by means of invoices, notes, receipts, etc. that the number of kilometres and the amount of car expenses are correct',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Business meals: When holding business lunch meeting a list of all participants (name and company) must be provided, including person hosting the event',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office_supplies, Equipment, Training, Telecommunications, Mileage, Transportation',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          "Expenses will be paid out 1 to 3 days after the monthly payroll run and will not be reflected in the worker's pay slip",
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office_supplies, Equipment, Training, Telecommunications, Mileage, Transportation',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Expenses will be paid out towards the end of the month. All approved expenses will be paid as NET to the employee and grossed up if they are not tax-free',
      },
    ],
  },
  China: {
    ...
    compliancePoliciesGrossUpRelated: [
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Fuel fees on cars not owned by employer: Usually paid as taxable Car Allowance between RMB 1.5-2.5 per KM. Common rate 1.5 to 2.5 yuan per kilometer',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'Parking fees and highway tolls: Either Corporate Income Tax (25%) or Individual Income Tax applied if cannot prove expenses for entertaining customers',
      },
      {
        travel_non_travel_both: 'Travel',
      ...
      },
      {
        ...
        gross_up: false,
        gross_up_rule:
          'Office equipment (laptops, etc.), Work-protection tools, Fixed assets/furniture/electrical appliances are tax exempt for both employer and worker',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        ...
        gross_up: false,
        gross_up_rule:
          'Electronic products and accessories, communication equipment (routers, cell phones, except gifts to employees) are tax exempt for both employer and worker',
      },
      {
        travel_non_travel_both: 'Non-Travel',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Telephone/communication fee invoices with individual name (SIM card NOT registered under company name) are subject to Individual Income Tax for worker',
      },
      {
        travel_non_travel_both: 'Non-Travel',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Entertainment service fees for team building activities (dinners, beverages, KTV, tourist attractions, refreshments, food, cigarettes) subject to Corporate Income Tax (25%) for employer, tax exempt for worker',
      },
      {
        travel_non_travel_both: 'Both',
        ...
        gross_up: true,
        gross_up_rule:
          'Entertainment expenses with clients (meals, beverages, spirits, tobacco, KTV, tourist attractions, refreshments) subject to Corporate Income Tax (25%) for employer, tax exempt for worker',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'Small and medium-sized appliances (microwave ovens, except gifts to employees) subject to Corporate Income Tax (25%) for employer, tax exempt for worker',
      },
      {
        travel_non_travel_both: 'Non-Travel',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Shopping cards and red packets (Hong Bao) for employees as gifts subject to Corporate Income Tax (25%) for employer AND Individual Income Tax for worker',
      },
      {
        travel_non_travel_both: 'Non-Travel',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Daily cleaning/hygiene products (dishwashing liquid, cosmetics) either Corporate Income Tax (25%) or Individual Income Tax applied',
      },
      {
        travel_non_travel_both: 'Non-Travel',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Marketing Activity expenses with single tax fapiao amount bigger than CNY30,000 (about USD4500) without service contract may be challenged by tax bureau',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'If GoGlobal required to process entertainment expense reimbursement, involved corporate income tax (15%-25%) passed to end client',
      },
      {
        travel_non_travel_both: 'Both',
        ...
        gross_up: true,
        gross_up_rule:
          "Claims without proper Fapiao considered as employee income and subjected to personal income tax with monthly salary. Tax rate based on individual's accumulated annual income from 3% to 45%",
      },
    ],
    compliancePoliciesAdditionalInfoRelated: [
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          "Original invoice and deduction sheet must be sent to Local Employer's Dalian Branch: Name: Sylvia Jiang, Office Address: 大连市高新园区高新街9号晟辉科技大厦703室, Tel.: +86 17615158127 or 0411-81760355 dial 808. Use S.F. Express paid by shipper and collect express fee invoice for reimbursement",
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Train, Restaurant, Taxi, Office supplies, Software, Equipment, Telecommunications',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          "Manager approval required. Submit expense reimbursement form to direct manager with Local Employer cc'd payroll.all@talentbankglobal.com, indicating total amount in email body",
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Forward approved emails/documents and completed expense reimbursement template to payroll.all@talentbankglobal.com before 5th of month',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Exchange rate documentation required - use spot exchange purchase price issued by Bank of China on first working day of month after returning from business trip. Foreign currency expenses must be entered line by line according to invoices',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Air ticket itinerary required as auxiliary certificate showing round trip air ticket, ticket itinerary. For travel agency purchases: invoice with worker name, round trip city and time period required',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Train',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Printed paper train tickets required as proof of expense. National train ticket reimbursement certificate can be printed at station ticket window and automatic ticket vending machines',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        additional_info_required: true,
        additional_info_rule:
          'For Didi or other ride-hailing apps: trip details/itinerary required along with official tax bureau invoice. Exception: "Didi Chuxing" can provide "car-hailing service fee" invoices for express/special cars',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Business justification required proving expenses for entertaining customers. Personal car license plate number on invoice cannot be reimbursed directly',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Documentation of city tier classification required for per diem rates: 1st tier (Beijing, Shanghai, Guangzhou, Shenzhen), new 1st tier and 2nd tier cities listed, 3rd tier (all other cities)',
      },
      {
        travel_non_travel_both: 'Non-Travel',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Contract required between Local Employer and provider for company services (IT services, advertising agencies). Worker must contact Local Employer 5 working days in advance',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Marketing activities over CNY30,000',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Service contract required for marketing expenses with single fapiao amount over CNY30,000 to avoid tax bureau challenge',
      },
      {
        travel_non_travel_both: 'Both',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Business purpose required if not shown on receipt - indicate on expense report. Business relationship to taxpayer or persons involved required if not shown on receipt - indicate on expense report',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Hard copy documents submitted to GoGlobal Finance Team: Room B102, Block B, Jiaozi Financial Technology Center, No. 1677, north section of Tianfu Avenue, Guixi street, Wuhou District, Chengdu, Sichuan Province, Tel: 19921181138',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Fapiaos pasted on A4-sized paper in chronological order following expense claim form sequence, similar-sized fapiaos grouped on one sheet. Electronic fapiaos must be printed',
      },
    ],
  },
  France: {
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: false,
        gross_up_rule:
          'Many business expenses related to workers completing their job will be tax exempt. Only purely business related elements of this expense will be tax free, anything additional will be subject to tax',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Telecommunications',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Domestic business travel: meals treated as non-taxable income up to government set subsistence costs. International travel: per diem reductions apply - if hotel paid on receipt reduction by 65%, if one meal reimbursed on receipt reduction by 17.5%, if two meals reimbursed on receipt reduction by 35%',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        gross_up: true,
        gross_up_rule:
          'French Government sets specific mileage rates determined by fiscal engine size expressed in CV (3 to 7). Rates vary by distance: up to 5,000 km, 5,001 to 20,000 km, beyond 20,000 km. For electric vehicles, amount is increased by 20%',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        gross_up: false,
        gross_up_rule:
          'Employers must pay 50% of cost of season tickets for public transport between residence and workplace. Cost based on 2nd class fare and shortest route. This reimbursement processed through payroll and exempt from social security contributions',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
        ...
        gross_up: true,
        gross_up_rule:
          'For alcoholic beverages: 1 glass per person at business meal allowed. When reimbursement of more drinks per person requested, right to decline whole reimbursement claim. Only wine, beer (maximum 33cl), or cider accepted. Spirits prohibited',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
    ...
    compliancePoliciesAdditionalInfoRelated: [
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          "Documents must be actual tax receipts or invoices ('justificatifs'); booking confirmations will not suffice. Date in Country, time of arrival, date and time of departure confirmations of flight/hotel bookings do not count as taxable documents",
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office_supplies, Equipment, Training, Telecommunications, Mileage, Transportation',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Detailed mileage log reports justifying business mileage required including dates, purpose of trips, destinations, and kilometers travelled for each business journey',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'All details must be included: worker will need to provide details of trip destination (start point-end point) + Copy of the Car certificate ("carte grise" stating HP fiscal engine size)',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Any invoice with total amount exceeding €450.00 needs to be sent to local employer as hard copy including detailed address of Parakar',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office_supplies, Equipment, Training, Telecommunications, Mileage, Transportation',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'For per diem method, no receipts or invoices need to be provided. However, proof of business trip itself is essential. Company policy might still require receipts for internal control',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Expenses like parking or toll fees are not included in mileage allowance. These can be claimed separately based on receipts',
      },
    ],
  },
  Germany: {
    receiptStandards: [
      {
        ...
        travel_non_travel_both: 'Both',
        expense_type:
          'Hotel, Flight, Restaurant, Office supplies, Software, Equipment, Training, Entertainment, Utilities, Professional services, Medical',
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: false,
        gross_up_rule:
          'Office equipment (business use), Training (job-related) are tax exempt providing correct criteria is followed and genuine business use',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Telecommunications',
      ...
      },
      {
        ...
        gross_up: false,
        gross_up_rule:
          'IT equipment that is considered as company property, Office supplies that are relevant and reasonable in amount are tax exempt',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'Meals (outside of business travel report), Fuel, Phone Bill, Transportation to workplace, Office groceries, Other items which are not essential to carry out work activity are not tax exempt and employees should be compensated',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Entertainment',
        ...
        gross_up: true,
        gross_up_rule:
          'Entertainment expenses qualify only if offered to third party as well. Entertainment expenses solely for employees of same company will not be accepted',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Telecommunications',
        ...
        gross_up: true,
        gross_up_rule:
          'Telephone costs can only be reimbursed tax-free at flat rate of up to 20% of invoiced amount, up to maximum of EUR 20 per month',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Telecommunications',
        ...
        gross_up: true,
        gross_up_rule:
          'Mobile phone usage can only be reimbursed tax-free if worker uses separate phone for personal use and can provide proof of this phone',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Telecommunications',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Reimbursement of average expenses on business behalf: Based on three month record an average percentage rate is determined on how much private cell phone is used for business purposes',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Domestic: €28 for full day (24h), €14 for arrival/departure days. International: per diem rates vary per country according to government rates. Any per diem rate offered above government set rate will be fully taxable',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
        ...
        gross_up: true,
        gross_up_rule:
          'Per diems are only tax-free for up to three months of continuous business travel in given location (3-month rule or 3-Monatsfrist). Long stay of more than three months are taxable',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type:
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Business expenses related to workers completing their job will usually be tax exempt. Other expenses are subject to varying tax rules. Only purely business related elements of this expense will be tax free, anything additional will be subject to tax',
      },
    ],
    compliancePoliciesAdditionalInfoRelated: [
      {
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Familiarize your worker on how to report their expenses through Expensify or a manual expense report (to be agreed between the worker and manager)',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Mileage reimbursement requires providing a Fahrtenbuch (mileage logbook), which must include date, route, purpose, and odometer readings (a Mileage log sample is available on request)',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          "Worker will need to share a map with the relevant route (google maps is sufficient) and complete Global People's travel report where applicable",
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Per diem method cannot be mixed up with actual expenses. You will need to agree with the worker on one method per business trip',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
        ...
        additional_info_required: true,
        additional_info_rule:
          'If meals have been pre-arranged the meal allowance should be reduced by 20 to 40% depending on which meals were provided',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
        ...
        additional_info_required: true,
        additional_info_rule:
          'If breakfast is included e.g. in the hotel fee, 20% of the flat rate will be deducted for the day. If lunch or dinner is provided by the employer, 40% of the fee will be removed',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
        ...
        additional_info_required: true,
        additional_info_rule:
          'For Domestic business trips, the total allowance per day is reduced to zero when all meals (breakfast, lunch and dinner) are provided',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
        ...
        additional_info_required: true,
        additional_info_rule:
          'No receipts or invoices need to be provided when using the per diem method. Receipts are not required for per diem when expensing a fixed daily allowance',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Business travel expenses must be submitted using this report: Travel Expense Report.xlsx. All travel related expenses must be reported using this template',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          "For entertainment expense to qualify, entertainment has to have been offered to third party as well. Invoices are required to note Global People's name, address and VAT amount",
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Supporting documents required to ensure the flight reimbursement is processed as net: missing payment receipt/invoice as well as ticket copy',
      },
      {
        travel_non_travel_both: 'Travel',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'When submitting an expense the description of the reason for the expense, should be as precise and detailed as possible',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type:
        ...
        additional_info_required: true,
        additional_info_rule:
          'Parakar only accepts expenses that are properly documented by means of invoices or receipts from the provider, that specify the service provided',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type:
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'One consolidated report per employee. Expanse details- type of expanse, context, copy of the invoice. Business trip report- each trip needs to be reported on separate report',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type:
        ...
        additional_info_required: true,
        additional_info_rule:
          'Any expenses that needs to be paid as a benefit-gross amount- must be reported as a one time allowance and not as an expanse',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type:
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Reimbursement of airfare ticket for personal trip (expatriate employee round trip ticket to home country) is taxable BIK - subject to gross-up. Business trip airfare is non-taxable',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Restaurant',
        ...
        gross_up: true,
        gross_up_rule:
          'Personal meals during business trip are taxable BIK - subject to gross-up. Business lunch/entertainment with client/prospect client/vendor is non-taxable',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Telecommunications',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Reimbursement of fuel and toll from car rental or on private car used is taxable BIK - subject to gross-up. Mileage reimbursement rates are at employer discretion',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Office supplies',
      ...
      },
      {
        ...
        gross_up: false,
        gross_up_rule:
          'Reimbursement of taxi for visiting client office, government/tax office for business purpose is non-taxable - no gross-up required',
      },
      {
        travel_non_travel_both: 'Both',
        ...
        gross_up: true,
        gross_up_rule:
          'Business expenses related to workers completing their job might be tax exempt - other expenses are subject to varying tax rules including PPh 21 Tax Rate. Only purely business related elements will be tax free, anything additional will be subject to tax',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel',
        ...
        gross_up: true,
        gross_up_rule:
          "Car rental dedicated for employee and the car is parked at the employee's home (not parked in the office) is taxable BIK. Reimbursement of car rental used during business trip is non-taxable",
      },
      {
        travel_non_travel_both: 'Both',
        ...
        gross_up: true,
        gross_up_rule:
          'Reimbursement of medical claims personal and medical insurance premium (additional insurance provided to employee and family on top of mandatory benefit) are taxable BIK',
      },
      {
        travel_non_travel_both: 'Both',
    ...
    compliancePoliciesAdditionalInfoRelated: [
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Business purpose must be established clearly - any expense where business purpose cannot be established will be rejected or postponed',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          "Workers set up under Papaya's Partner EoS must submit expenses via their expenses template before the 15th of each month along with the VAT invoices",
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office supplies, Software, Equipment, Training, Mileage, Taxi, Professional services',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          "When working with Papaya's Partner EoS the hard copy original invoices and receipts need to be sent to the company's office address as required for tax and audit process",
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office supplies, Software, Equipment, Training, Mileage, Taxi, Professional services',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Expense submissions must have an itemized report along with clear receipts - properly labeled receipts for identification',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office supplies, Software, Equipment, Training, Mileage, Taxi, Professional services',
  ...
  Italy: {
    ...
    compliancePoliciesGrossUpRelated: [
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'All expense that has been approved by the client as a business expense will be NET to the employee (grossed up if not tax free)',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Entertainment',
        ...
        gross_up: true,
        gross_up_rule:
          'Meals offered to a client/supplier is labeled as "spese di rappresentanza" (entertainment expenses) and is tax free up to 75% of the whole amount - remaining 25% is taxable',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
    ...
    compliancePoliciesAdditionalInfoRelated: [
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'You cannot mix per diem method with actual expenses. You will need to agree with the worker on one method per business trip',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Scan of the card passport (libretto di circolazione), as it will contain all information regarding the car owner must be provided',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Any screenshot from any app that can track start point, arrival point and KM will work (like google maps) to keep track of the travelled KM',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Per diem amounts may vary according to NCBA. For Commercio NCBA for example, in case of business trip with no overnight stay, per diem will be reduced by 1/3',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Entertainment',
  ...
  Japan: {
    receiptStandards: [
      {
        ...
        travel_non_travel_both: 'Both',
        expense_type:
          'Hotel, Flight, Restaurant, Office supplies, Equipment, Software, Training, Transportation, Mileage, Shipping, Employee engagement',
        icp_name: 'GoGlobal',
        mandatory_optional: 'Mandatory',
    ...
    compliancePoliciesAdditionalInfoRelated: [
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Original receipts must be pasted/stapled onto A4-sized sheets and mailed to GoGlobal K.K. 19F 4-1-28 Toranomon Minato-ku, Tokyo 105-0001. All hard copies must be received by 8th or the previous business day if 8th is a holiday for processing in the same month',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
  ...
  Poland: {
    ...
    compliancePoliciesGrossUpRelated: [
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Domestic travel: The current rate is 45 PLN per day. Duration of Trip up to 8 hours = 0%, between 8 – 12 hours 50%, More than 12 hours 100%. It is possible to increase the daily per diem rate. However, any portion of the per diem amount that exceeds the set Government rate will be taxable',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Restaurant',
        ...
        gross_up: true,
        gross_up_rule:
          'Domestic travel: When meals are provided free of charge to the employee the meal allowance is reduced by Breakfast 25%, Lunch 50%, Dinner 25%',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Restaurant',
        ...
        gross_up: true,
        gross_up_rule:
          'International travel: Duration up to 8 hours = 1/3 of allowance, between 8 and 12 hours: 50%, more than 12 hours = 100%. When meals are provided free of charge the meal allowance is reduced by: Breakfast – 15%, lunch – 30% and dinner 30%. Any portion that exceeds the set Government rate will be taxable',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel',
        ...
        gross_up: true,
        gross_up_rule:
          'Domestic accommodation: amount for an overnight stay cannot exceed 20 times the amount of the allowance (PLN 900). If accommodation not provided and no bill submitted, entitled to lump-sum payment of 150% of the allowance',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel',
        ...
        gross_up: true,
        gross_up_rule:
          'International accommodation: reimbursement up to limits set in regulations for each country. If no bill provided, entitled to lump-sum payment of 25% of the limit. Higher costs may be reimbursed in justified cases, but surplus over limit constitutes revenue for employee',
      },
    ],
    compliancePoliciesAdditionalInfoRelated: [
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Receipts and invoices must be submitted with expenses. Online copies are sufficient. Documents must be actual tax receipts or invoices; booking confirmations will not suffice',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office supplies, Equipment, Taxi, Training, Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Only invoices that are hard copies are needed to be sent to GoGlobal in Warsaw. Invoices made electronically are accepted and there is no need to provide hard copies',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office supplies, Equipment, Taxi, Training, Mileage',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'For mileage, a log book will need to be submitted. Must include: start/end (date and time), reason from travel, location and approval. This has to be documented in the vehicle mileage log kept by the employee',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Restaurant',
        ...
        additional_info_required: true,
        additional_info_rule:
          'For Per diems, a log book will need to be submitted. Must include: start/end (date and time), reason from travel, location and approval',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office supplies, Equipment, Taxi, Training, Mileage',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Per diem is not mandatory to use, and you can choose to give based on actual receipts to the worker. Any travel policy should be agreed upon prior to the worker starting',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Expenses that fall outside of per diem can be reimbursed as expense reimbursements against receipts however will be taxed',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant',
        ...
        additional_info_required: true,
        additional_info_rule:
          'For international travel, employee must receive advance payment before departure. After return, employee must settle travel within 14 days with supporting documents',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant',
  ...
  'South Korea': {
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: false,
        gross_up_rule:
          'Business expenses related to workers completing their job will usually be tax exempt. Only purely business related elements of an expense will be tax free',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant',
        ...
        gross_up: true,
        gross_up_rule:
          'There are no set government per diem rates but employer can set their own to be used to cover meals, which will be treated as non-taxable income up to 200,000 KRW per month',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        gross_up: true,
        gross_up_rule:
          'Mileage reimbursement rates between 50 to 80 cents per mile is common. If employee uses own vehicle and submits receipts only, entire amount is non-taxable. If employee claims both receipts and mileage reimbursement, the mileage reimbursement is fully subject to taxation as an allowance',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Other',
    ...
    compliancePoliciesAdditionalInfoRelated: [
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Receipts and invoices must be submitted with expenses. Online copies are sufficient, hard copy not required but workers should keep these filed',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office_supplies, Equipment, Training, Telecommunications, Mileage, Transportation',
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Domestic business travel per diem: €53.34 per day with overnight stay, €26.67 per day without overnight stay. International business travel per diem: €91.35 per day with overnight stay, €48.08 per day without overnight stay. Any amount spent above the per diem will be taxable',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant',
        ...
        gross_up: true,
        gross_up_rule:
          'All expenses will be processed via receipts and invoices instead of per diem method. Tax treatment applies based on actual expenses incurred',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant',
        ...
        gross_up: true,
        gross_up_rule:
          'Per diems will not be used, instead all expenses will be processed via receipts and invoices. All expenses are subject to taxation review based on actual amounts',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
        ...
        gross_up: true,
        gross_up_rule:
          'The current (2024) mileage rate is €0.26 per kilometer tax-free. Employers may choose to reimburse more than the above, but the higher rate per kilometer is considered taxable income for the employee and must be reported accordingly',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Office supplies, Software, Equipment',
        ...
        gross_up: false,
        gross_up_rule:
          'Many business expenses related to workers completing their job will be tax exempt, providing sufficient proof is shared such as tax receipts, invoices',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Restaurant',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'When employee uses public transport, the amount of the expense must be justified by an invoice or equivalent document. Otherwise, €0.19 per kilometre travelled plus toll and parking costs that are justified',
      },
    ],
    compliancePoliciesAdditionalInfoRelated: [
      {
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Excel Log book & Travel expenses template must be submitted with the expense reimbursement request. If a different template is used it should include details of Start and End Date, Start and Destination Point, Purpose of the Trip and list all expenses',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Employee must report date, starting point, end point, number of km and detail the business purpose. Screenshot/printout of the travel route using GoogleMaps or similar site required. Report must be signed both by employee and employer. Electronic signature is allowed',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          "For trips carried out in one month and exceeding 200 euros, additional business justification required. Complete the template letter, obtain the client's signature, and provide a copy",
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office supplies, Software, Equipment, Taxi, Training, Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Receipts and invoices must be submitted with expenses. Online copies are sufficient, hard copy not required. Documents must be actual tax receipts or invoices; booking confirmations will not suffice',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office supplies, Software, Equipment, Taxi, Training, Mileage',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'For the purposes of travel allowances, the payer must prove the date and place of the trip, as well as the reason or motive',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Hotel, Flight, Restaurant, Office supplies, Software, Equipment, Taxi, Training, Mileage',
  ...
  Switzerland: {
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: false,
        gross_up_rule:
          'Business expenses related to workers completing their job are usually tax exempt. Expenses which are business related e.g. laptops, office supplies, etc. will be tax free providing sufficient proof is included',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Training',
        ...
        gross_up: true,
        gross_up_rule:
          'Other expenses are subject to varying tax rules. All approved expenses will be paid as NET to the employee and grossed up if they are not tax free',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Office supplies, Software, Equipment',
        ...
        gross_up: true,
        gross_up_rule:
          'Smaller business expenses tax-free can be reimbursed against receipts (e.g. expenses that occur during a business trip) of a maximum of CHF 20 - amounts above this limit may be subject to tax',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Domestic and International: Breakfast CHF 15.00, Lunch CHF 35.00, Dinner CHF 40.00 tax-free. Any portion of per diem amount that exceeds the set rate will be taxable and must have a receipt provided',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'Overnight expenses such as hotels and transport should be reimbursed as expenses against receipts and invoices - all approved expenses will be paid as NET to employee and grossed up if not tax free',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Entertainment, Medical',
    ...
    compliancePoliciesAdditionalInfoRelated: [
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'The receipts/invoices should be reported in the local currency the worker will need to add the FX rate they have used to calculate the expense',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type:
  ...
  Taiwan: {
    receiptStandards: [
      {
        ...
        travel_non_travel_both: 'Both',
        expense_type:
          'Hotel, Flight, Train, Restaurant, Taxi, Office supplies, Equipment, Telecommunications, Shipping, Training, Insurance, Mileage',
    ...
    compliancePoliciesGrossUpRelated: [
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'The upper tax exempted limit of monthly meal allowance per person (including Overtime meals) is NT 3,000. Amounts above this limit will be subject to tax',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        gross_up: false,
        gross_up_rule:
          'Domestic and international business travel expenses follow the same process as reimbursement of non-travel expenses. There are no set government per diem rates and employers can reimburse against receipts and invoices. If reimbursed against receipts and invoices then these will be tax exempt',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Mileage',
        ...
        gross_up: true,
        gross_up_rule:
          'Mileage reimbursement rates and rules for workers who use their private vehicles for work purposes are not stipulated in the Labour Code. Reimbursement of mileage, fuel, parking, and car expenses is done at the discretion of each employer',
      },
      {
        travel_non_travel_both: 'Both',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Without these documents, any applicable tax exemption cannot be applied. Tax exemptions will only be applied providing sufficient proof is shared e.g. tax receipts, invoices, etc',
      },
      {
        travel_non_travel_both: 'Both',
        ...
        gross_up: true,
        gross_up_rule:
          'Expenses for spouses, partners, and other family members. Personal expenses (any non-business-related expenses). Any casual emolument or benefit attached to an office or position in addition to salary or wages (e.g., salary of house help, gas, water, or electricity bills, school fees, personal travel)',
      },
      {
        travel_non_travel_both: 'Both',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Supplemental Benefit – Personal Insurance listed as accepted expense but expenses that fall under taxable income will be treated as per the local regulations',
      },
    ],
    compliancePoliciesAdditionalInfoRelated: [
      {
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Submit expense claims with clear and legible copies of receipts to Client line manager for approval preferably within the same month of the expense',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Client line manager review and approval required - ensure expenses have all correct and needed information and clear business purpose',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Share with GoGlobal the approved expenses per worker before the payroll cut off date to process them in the same month',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'GoGlobal validates receipts according to local regulations and follows up on missing or questionable receipts, postpones or rejects reimbursements if required for compliance and taxability',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Online copies can be submitted for the expense payment but employees will need to submit hard copy receipts to the Taiwan local rep for company tax purposes',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Review submitted expense reports and approve expense claims, ensuring all required supporting documents have been included e.g. receipts, invoices, by the agreed cutoff date',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          "Expense reimbursements will be processed within the monthly payroll run and will be reflected in the worker's pay slip",
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'If claimed for reimbursement, workers should submit a mileage claim report which consists of the travel details which include the date, total distance of traveling, departure & arrival city, mileage rate and total mileage claimed, business purpose (name of customers visited)',
      },
      {
        travel_non_travel_both: 'Travel',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Familiarize worker on how to report expenses through Expensify or manual expense report (to be agreed between worker and manager)',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Determine internal process and expense policy so that they know the method and deadline for submitting expense claims to their Line Manager and how – via Expensify or Papaya expense report template',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
  ...
  Thailand: {
    ...
    compliancePoliciesGrossUpRelated: [
      ...
      },
      {
        ...
        gross_up: false,
        gross_up_rule:
          'If expenses are reimbursed as normal against receipts and invoices (with the Local Employers details) then these will be tax exempt for both domestic and international business travel',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'There are no set government per diem rates and any fixed lump sum allowance given will be taxable for both domestic and international travel',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'Reimbursement of mileage, fuel, parking and car expenses are done at the discretion of each employer. To be tax exempt workers must submit a travelling report approved by their manager',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Non-business elements',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Tax exemptions will only be applied providing sufficient proof is shared e.g. tax receipts, invoices etc, with the Local Partners details on the supporting documents',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'Personal and family expenses',
    ...
    compliancePoliciesAdditionalInfoRelated: [
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Where a particular receipt must state the workers name e.g. internet or mobile bill, the Local Employer will request in writing to the worker that they submit a petty cash form with the original receipts copy for reference',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Determine internal process and expense policy including method and deadline for submitting expense claims to Line Manager',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expenses',
  ...
  Vietnam: {
    receiptStandards: [
      {
        ...
        travel_non_travel_both: 'Both',
        expense_type:
          'Hotel, Flight, Restaurant, Office supplies, Equipment, Software, Training, Transportation, Mileage, Shipping, Employee engagement, Insurance',
        icp_name:
          'AYP HR GROUP COMPANY LIMITED, CÔNG TY TNHH DỊCH VỤ SIGMA, GOGLOBAL VIETNAM COMPANY LIMITED, CÔNG TY TNHH TIGER CONSULTING VIỆT NAM, GoGlobal',
        mandatory_optional: 'Mandatory',
        rule: 'Receipt must show the date when the expense occurred',
      },
      {
      ...
      },
      {
        ...
        expense_type:
          'Hotel, Flight, Restaurant, Office supplies, Equipment, Software, Training, Transportation, Mileage, Shipping, Employee engagement, Insurance',
        icp_name:
          'AYP HR GROUP COMPANY LIMITED, CÔNG TY TNHH DỊCH VỤ SIGMA, GOGLOBAL VIETNAM COMPANY LIMITED, CÔNG TY TNHH TIGER CONSULTING VIỆT NAM',
        mandatory_optional: 'Mandatory',
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Approved expenses can be paid to worker as NET and grossed up if they are not tax-free. Tax exemptions will only be applied to purely business related elements',
      },
      {
        travel_non_travel_both: 'Both',
        ...
        gross_up: true,
        gross_up_rule:
          'For those cost without eligible invoice/Proof document or rejected for claim, Corporate Income Tax (20%) will be charged as per current regulations',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
    ...
    compliancePoliciesAdditionalInfoRelated: [
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Where invoices do not have clear details e.g. written as "Meal and Drink cost", the worker must also submit a detailed list of each item as supporting document',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Flight',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Air tickets should be supported with itinerary in the name of employee or the invoice issued by travel agency in the name of employer. If the employee purchases travelling insurance, the quota invoice issued by insurance company is acceptable',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel',
        ...
        additional_info_required: true,
        additional_info_rule:
          'If hotel invoice cannot show unit, quantity, unit price per night, total cost information, then booking details with red stamp of hotel must also be submitted',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Railway tickets in Vietnam have a specific purple pink color and can thus be used to replace the Tax invoice at any rates. When an online booking method is used, the electronic invoice with the Boarding Pass must be submitted. A booking reference or receipt will not be accepted instead of bus ticket',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Transportation',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Ground transportation fee shall be supported with the taxi invoice. If the employee uses Grab/Bee or other apps to call a car, both invoices and trip details are necessary to be submitted',
      },
      {
        travel_non_travel_both: 'Both',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Worker will need to contact Papaya who will arrange for the Local Employer to reimburse via bank transfer to Vendor. Payment documents must include Service/Sales Contract, Liquidation Agreement signed by Local Employer and stamped. It could take up to 2 weeks to process these payments',
      },
      {
        travel_non_travel_both: 'Both',
        ...
        additional_info_required: true,
        additional_info_rule:
          'VAT/Red receipts must be posted to: Hoàng Như Ngọc (0979737268) – 7.03 Newtown apartment, Hiep Binh Chanh ward, Thủ Đức, HCMC',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'VAT/Red receipts',
        ...
        additional_info_required: true,
        additional_info_rule:
          'VAT/Red receipts must be posted to: No 67, Mertia Khang Dien, Lien Phuong Street, Phuong Long B Ward, Thu Duc City – Ho Chi Minh City',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'VAT/Red receipts',
        ...
        additional_info_required: true,
        additional_info_rule:
          'VAT/Red receipts must be posted to: Address: Số 2, Đường Ngô Đức Kế, Phường Bến Nghé, Quận 1, Thành phố Hồ Chí Minh, Việt Nam',
      },
      {
        travel_non_travel_both: 'Both',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Review submitted expense reports and approve expense claims, ensuring all required supporting documents have been included by the agreed cutoff date',
      },
    ],
  },
  Australia: {
    receiptStandards: [
      {
        ...
        travel_non_travel_both: 'Both',
        expense_type:
          'Hotel, Flight, Restaurant, Office supplies, Software, Equipment, Training, Professional services, Medical, Telecommunications, Utilities, Mileage, Entertainment',
        icp_name: 'Local Employer (specific entity name not provided in document)',
        mandatory_optional: 'Mandatory',
        rule: 'Receipt or invoice must display the supplier business name',
      },
      {
        required_data: 'Transaction date',
        travel_non_travel_both: 'Both',
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Business expenses related to workers completing their job (laptops, office supplies etc.) are usually tax exempt when purely business-related. Any non-business or personal elements will be subject to tax',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'Health insurance and wellness benefits are not tax exempt business expenses and must be processed as Fringe Benefits Tax (FBT) and subject to taxation',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
        ...
        gross_up: false,
        gross_up_rule:
          'Motor vehicle or car expenses when work-related can be claimed tax-free using either cents per kilometer method or logbook method per ATO guidelines',
      },
      {
        travel_non_travel_both: 'Travel',
        ...
        gross_up: true,
        gross_up_rule:
          'Domestic business trips are non-taxable up to the daily per diem limit (covers lodging, meals, and incidentals) based on worker income level. Any expenditure exceeding the per diem rates will be taxed as ordinary income',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Meals, Flight',
        ...
        gross_up: true,
        gross_up_rule:
          'International business trips use ATO per diem method with set rates for subsistence costs (lodging, meals, incidentals) tax-free based on worker income and destination country. Any expenditure exceeding per diem rates will be taxed as ordinary income',
      },
      {
        travel_non_travel_both: 'Both',
        ...
        gross_up: true,
        gross_up_rule:
          'If a receipt is not provided, the expense will be fully taxed. Without supporting documents, any applicable tax exemption cannot be applied',
      },
    ],
    compliancePoliciesAdditionalInfoRelated: [
      {
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Workers must submit tax form each year (July to October) to claim any applicable tax deduction. Workers can use ATO myDeductions tool to track and manage expenses throughout the year',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'For domestic travel, workers must provide: (1) Travel proof in the form of tickets and hotel reservations, (2) Rough estimate of expenditure if actual receipts not available, (3) Proof of money spent (credit card statement or other banking records)',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Meals, Flight',
        ...
        additional_info_required: true,
        additional_info_rule:
          'For international travel exceeding 6 days, workers must keep copies of all receipts for the travel (incidental expenses, accommodation, etc.) as ATO might request them during tax return checks',
      },
    ],
  },
  India: {
    ...
    compliancePoliciesGrossUpRelated: [
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Business expenses related to workers completing their job will usually be tax exempt. Only purely business related elements of an expense will be tax free, anything additional will be subject to tax. Tax exemptions will only be applied providing sufficient proof is shared',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
        ...
        gross_up: false,
        gross_up_rule:
          'Workers using private vehicles, including cars, vans, motorbikes and bicycles, for work purposes should be reimbursed tax free according to the mileage traveled',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant, Transportation',
      ...
      },
      {
        ...
        gross_up: true,
        gross_up_rule:
          'Without supporting documents any applicable tax exemption cannot be applied. If receipts or invoices are not provided, the expense will be subject to tax',
      },
    ],
    compliancePoliciesAdditionalInfoRelated: [
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Manager must review submitted expense reports and approve expense claims, ensuring all required supporting documents (receipts, invoices) have been included by the agreed cutoff date',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expense types',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'Submit expenses using template: India (Procloz) Expense Receipts Summary.xlsx. Template requires: Employee ID, Employee Name, Date of the Expense, Expense Description, Amount (in local currency), FX rate, Amount (in INR), File name of the receipt',
      },
      {
        travel_non_travel_both: 'Both',
        expense_type: 'All expense types',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Submit expenses using template: Expense report template INR.xlsx. Template requires: Employee Name, Department, Phone, Employee ID, Starting Date, Ending Date, Travel From, Travel To, Purpose',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Minimum mileage rate: 20 INR per km (each employer can set their own specific rate). Mileage must be recorded and submitted within the monthly expense reimbursement report. Receipts must be provided for audit purposes',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Mileage rate: 14 INR per km. Mileage must be recorded and submitted within the monthly expense reimbursement report including: reimbursement rate, total miles, and total mileage reimbursement calculation',
      },
      {
        travel_non_travel_both: 'Non-Travel',
        expense_type: 'Mileage',
        ...
        additional_info_required: true,
        additional_info_rule:
          'For each mileage expense: Date, Vehicle Type (Rental, Work, or Personal), Total KM, Comments must be documented. Map screenshot must be attached per ride showing distance traveled',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant, Transportation',
      ...
      },
      {
        ...
        additional_info_required: true,
        additional_info_rule:
          'International business travel: 25 USD per day. Receipts must be provided for audit purposes. Per diem can be paid upon the workers return, it does not need to be paid in advance',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant, Transportation',
        ...
        additional_info_required: true,
        additional_info_rule:
          'For expenses in foreign currency: Document original currency amount, foreign exchange rate (FX rate), and converted amount in INR (payment currency) in the expense report',
      },
      {
        travel_non_travel_both: 'Travel',
        expense_type: 'Hotel, Flight, Restaurant, Transportation',
        ...
        additional_info_required: true,
        additional_info_rule:
          'Travel information must be documented in expense report: Starting Date, Ending Date, Travel From location, Travel To location, and Purpose of trip',
      },
    ],
  },
  UAE: {
    ...
    compliancePoliciesGrossUpRelated: [
      ...
      },
      {
        ...
        gross_up: false,
        gross_up_rule:
          'Domestic and international business travel has no specific tax treatment mentioned. Workers can be reimbursed via expenses against receipts and invoices',
      },
    ],
    compliancePoliciesAdditionalInfoRelated: [
      {
