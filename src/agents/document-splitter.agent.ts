...
import { PageMarkdown, PageAnalysisResult, PageGroup } from '@/expense-document/types/upload.types';
...
export class DocumentSplitterAgent extends BaseAgent {
  ...
  constructor() {
    super();
    this.logger.log('Initializing DocumentSplitterAgent with vision support');
